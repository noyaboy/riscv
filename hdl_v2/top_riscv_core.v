...
(
    ...
    assign rs1_rdata_ID_muxed = (rs1_ID_fwd == 0)? rs1_rdata_ID:
        ...
        (rs1_ID_fwd == 4)? rd_wdata_RB: mem_rdata_M;
    ...
    assign pc_branch_ID = (instr_M[6:0] == `I_TYPE_LOAD && instr_ID[6:0] == `B_TYPE) ? pc_ID_org + imm_ID - 8 : 
                            (instr_ID[6:0] == `J_TYPE) ? pc_ID_org + imm_ID : pc_ID_org + imm_ID - 4;
